...
@pytest.fixture
def my_user():
    return {"name": "Sveta", "age": 18, "email": "sferdt345@bngh.bn"}
...
def test_reverse_string():
    assert reverse_string("Sveta") == "atevS"
...
def test_my_name(my_name):
    assert reverse_string("atevS") == "Sveta"
    assert reverse_string("name") == "eman"
...
def test_my_reverse_name(a, expected):
    assert reverse_string(a) == expected
